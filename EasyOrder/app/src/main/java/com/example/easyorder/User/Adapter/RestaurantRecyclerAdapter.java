...
public class RestaurantRecyclerAdapter extends RecyclerView.Adapter<RestaurantRecyclerAdapter.MyViewHolder>{
    ...
    int id_account;
    public RestaurantRecyclerAdapter(List<Resturant>resturants,Context context,int id_account){
    ...
    @NonNull
    @Override
    public RestaurantRecyclerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.restaurant_row,viewGroup,false);
        return new RestaurantRecyclerAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RestaurantRecyclerAdapter.MyViewHolder viewHolder, final int i) {
